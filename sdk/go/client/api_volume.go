...
*/
func (a *VolumeAPIService) CreateProjectZoneVolume(ctx context.Context, projectId string, zoneId string) ApiCreateProjectZoneVolumeRequest {
	return ApiCreateProjectZoneVolumeRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
//  @return Volume
func (a *VolumeAPIService) CreateProjectZoneVolumeExecute(r ApiCreateProjectZoneVolumeRequest) (*Volume, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VolumeAPIService.CreateProjectZoneVolume")
	if err != nil {
...
func (r ApiGetAllVolumesRequest) Execute() ([]string, *http.Response, error) {
...
// Execute executes the request
//  @return []string
func (a *VolumeAPIService) GetAllVolumesExecute(r ApiGetAllVolumesRequest) ([]string, *http.Response, error) {
	var (
...
*/
func (a *VolumeAPIService) GetPoolVolumes(ctx context.Context, poolId string) ApiGetPoolVolumesRequest {
	return ApiGetPoolVolumesRequest{
		ApiService: a,
		ctx: ctx,
		poolId: poolId,
...
// Execute executes the request
//  @return []string
func (a *VolumeAPIService) GetPoolVolumesExecute(r ApiGetPoolVolumesRequest) ([]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VolumeAPIService.GetPoolVolumes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *VolumeAPIService) GetProjectZoneVolumes(ctx context.Context, projectId string, zoneId string) ApiGetProjectZoneVolumesRequest {
	return ApiGetProjectZoneVolumesRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
//  @return []string
func (a *VolumeAPIService) GetProjectZoneVolumesExecute(r ApiGetProjectZoneVolumesRequest) ([]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VolumeAPIService.GetProjectZoneVolumes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateVolumeRequest) Body(body Volume) ApiUpdateVolumeRequest {
	r.body = &body
	return r
}
