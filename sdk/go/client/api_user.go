...
func (r ApiSetUserApiTokenRequest) Execute() (*ApiToken, *http.Response, error) {
...
// Execute executes the request
//  @return ApiToken
func (a *UserAPIService) SetUserApiTokenExecute(r ApiSetUserApiTokenRequest) (*ApiToken, *http.Response, error) {
	var (
