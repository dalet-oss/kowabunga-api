...
func (o *GetRegionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /region/{regionId}] GetRegion", response, response.Code())
	}
}
...
func (o *GetRegionOK) Error() string {
	return fmt.Sprintf("[GET /region/{regionId}][%d] getRegionOK  %+v", 200, o.Payload)
}
...
func (o *GetRegionNotFound) Error() string {
	return fmt.Sprintf("[GET /region/{regionId}][%d] getRegionNotFound ", 404)
}
