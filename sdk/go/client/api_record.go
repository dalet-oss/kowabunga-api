...
//  @return DnsRecord
func (a *RecordAPIService) CreateProjectDnsRecordExecute(r ApiCreateProjectDnsRecordRequest) (*DnsRecord, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RecordAPIService.CreateProjectDnsRecord")
	if err != nil {
...
type ApiGetDnsRecordRequest struct {
	ctx context.Context
	ApiService *RecordAPIService
	recordId string
}

func (r ApiGetDnsRecordRequest) Execute() (*DnsRecord, *http.Response, error) {
	return r.ApiService.GetDnsRecordExecute(r)
}

/*
GetDnsRecord Method for GetDnsRecord

Returns a DNS record object

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param recordId The ID of the DNS record to get.
 @return ApiGetDnsRecordRequest
*/
func (a *RecordAPIService) GetDnsRecord(ctx context.Context, recordId string) ApiGetDnsRecordRequest {
	return ApiGetDnsRecordRequest{
		ApiService: a,
		ctx: ctx,
		recordId: recordId,
...
// Execute executes the request
//  @return DnsRecord
func (a *RecordAPIService) GetDnsRecordExecute(r ApiGetDnsRecordRequest) (*DnsRecord, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RecordAPIService.GetDnsRecord")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateDnsRecordRequest) Body(body DnsRecord) ApiUpdateDnsRecordRequest {
	r.body = &body
	return r
}
