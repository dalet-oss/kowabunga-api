...
// WithZoneID adds the zoneID to the create host params
func (o *CreateHostParams) WithZoneID(zoneID string) *CreateHostParams {
	o.SetZoneID(zoneID)
	return o
}

// SetZoneID adds the zoneId to the create host params
func (o *CreateHostParams) SetZoneID(zoneID string) {
	o.ZoneID = zoneID
}
