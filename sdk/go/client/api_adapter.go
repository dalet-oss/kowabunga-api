...
*/
func (a *AdapterAPIService) ListSubnetAdapters(ctx context.Context, subnetId string) ApiListSubnetAdaptersRequest {
	return ApiListSubnetAdaptersRequest{
		ApiService: a,
		ctx: ctx,
		subnetId: subnetId,
...
// Execute executes the request
//  @return []string
func (a *AdapterAPIService) ListSubnetAdaptersExecute(r ApiListSubnetAdaptersRequest) ([]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdapterAPIService.ListSubnetAdapters")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
