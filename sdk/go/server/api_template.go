...
func (c *TemplateAPIController) CreateTemplate(w http.ResponseWriter, r *http.Request) {
	...
	if err := AssertTemplateRequired(bodyParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertTemplateConstraints(bodyParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.CreateTemplate(r.Context(), poolIdParam, bodyParam)
...
func (c *TemplateAPIController) UpdateTemplate(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.UpdateTemplate(r.Context(), templateIdParam, bodyParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
