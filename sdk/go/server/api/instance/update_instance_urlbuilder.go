...
func (o *UpdateInstanceURL) Build() (*url.URL, error) {
	...
	var _path = "/instance/{instanceId}"

	instanceID := o.InstanceID
	if instanceID != "" {
		_path = strings.Replace(_path, "{instanceId}", instanceID, -1)
	} else {
		return nil, errors.New("instanceId is required on UpdateInstanceURL")
	}
...
func (o *UpdateInstanceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateInstanceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateInstanceURL")
	}
