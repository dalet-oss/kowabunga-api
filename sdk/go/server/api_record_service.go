...
func (s *RecordAPIService) CreateProjectDnsRecord(ctx context.Context, projectId string, body DnsRecord) (ImplResponse, error) {
...
// UpdateDnsRecord - 
func (s *RecordAPIService) UpdateDnsRecord(ctx context.Context, recordId string, body DnsRecord) (ImplResponse, error) {
