...
// KyloAPIService is a service that implements the logic for the KyloAPIServicer
// This service should implement the business logic for every endpoint for the KyloAPI API.
// Include any external packages or services that will be required by this service.
type KyloAPIService struct {
}

// NewKyloAPIService creates a default api service
func NewKyloAPIService() KyloAPIServicer {
...
func (s *KyloAPIService) DeleteKylo(ctx context.Context, kyloId string) (ImplResponse, error) {
	...
	return Response(http.StatusNotImplemented, nil), errors.New("DeleteKylo method not implemented")
}
...
func (s *KyloAPIService) ReadKylo(ctx context.Context, kyloId string) (ImplResponse, error) {
	...
	// TODO: Uncomment the next line to return response Response(200, Kylo{}) or use other options such as http.Ok ...
	// return Response(200, Kylo{}), nil
