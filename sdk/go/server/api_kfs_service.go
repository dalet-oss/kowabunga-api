...
func (s *KfsAPIService) CreateProjectZoneKfs(ctx context.Context, projectId string, zoneId string, body Kfs, nfsId string, notify bool) (ImplResponse, error) {
...
// GetProjectZoneKfs - 
func (s *KfsAPIService) GetProjectZoneKfs(ctx context.Context, projectId string, zoneId string) (ImplResponse, error) {
...
// UpdateKFS - 
func (s *KfsAPIService) UpdateKFS(ctx context.Context, kfsId string, body Kfs) (ImplResponse, error) {
