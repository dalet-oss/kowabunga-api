...
func (s *VolumeAPIService) CreateProjectZoneVolume(ctx context.Context, projectId string, zoneId string, body Volume, poolId string, templateId string) (ImplResponse, error) {
...
// UpdateVolume - 
func (s *VolumeAPIService) UpdateVolume(ctx context.Context, volumeId string, body Volume) (ImplResponse, error) {
