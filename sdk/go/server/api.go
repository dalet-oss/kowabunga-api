...
type ProjectAPIServicer interface { 
	...
	CreateProjectZoneKFS(context.Context, string, string, Kfs, string) (ImplResponse, error)
	...
	ListProjectZoneKFSs(context.Context, string, string, string) (ImplResponse, error)
