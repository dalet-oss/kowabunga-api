...
import (
	...
	swaggerapi "github.com/dalet-oss/kowabunga-api/sdk/go/server/api"
	"github.com/dalet-oss/kowabunga-api/sdk/go/server/api/adapter"
	"github.com/dalet-oss/kowabunga-api/sdk/go/server/api/host"
	...
	"github.com/dalet-oss/kowabunga-api/sdk/go/server/api/project"
	"github.com/dalet-oss/kowabunga-api/sdk/go/server/api/record"
	"github.com/dalet-oss/kowabunga-api/sdk/go/server/api/region"
	"github.com/dalet-oss/kowabunga-api/sdk/go/server/api/subnet"
	"github.com/dalet-oss/kowabunga-api/sdk/go/server/api/template"
	"github.com/dalet-oss/kowabunga-api/sdk/go/server/api/vnet"
	"github.com/dalet-oss/kowabunga-api/sdk/go/server/api/volume"
	"github.com/dalet-oss/kowabunga-api/sdk/go/server/api/zone"
)

//go:generate swagger generate server --target ../../../../kowabunga-api --name Kowabunga --spec ../../../swagger.generated.yml --api-package api --model-package sdk/go/models --server-package sdk/go/server --principal interface{} --exclude-main
