...
func (c *RegionAPIController) CreateRegion(w http.ResponseWriter, r *http.Request) {
	...
	if err := AssertRegionRequired(bodyParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertRegionConstraints(bodyParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.CreateRegion(r.Context(), bodyParam)
...
func (c *RegionAPIController) UpdateRegion(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.UpdateRegion(r.Context(), regionIdParam, bodyParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
