...
export class RecordService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deleteDnsRecord(recordId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any>;
    public deleteDnsRecord(recordId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpResponse<any>>;
    public deleteDnsRecord(recordId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpEvent<any>>;
    public deleteDnsRecord(recordId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateDnsRecord(recordId: string, body?: DnsRecord, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<DnsRecord>;
    public updateDnsRecord(recordId: string, body?: DnsRecord, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<DnsRecord>>;
    public updateDnsRecord(recordId: string, body?: DnsRecord, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<DnsRecord>>;
    public updateDnsRecord(recordId: string, body?: DnsRecord, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (recordId === null || recordId === undefined) {
