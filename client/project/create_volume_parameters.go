...
func (o *CreateVolumeParams) WithBody(body *models.Volume) *CreateVolumeParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create volume params
func (o *CreateVolumeParams) SetBody(body *models.Volume) {
	o.Body = body
}
...
// WithProjectID adds the projectID to the create volume params
func (o *CreateVolumeParams) WithProjectID(projectID string) *CreateVolumeParams {
	o.SetProjectID(projectID)
	return o
}

// SetProjectID adds the projectId to the create volume params
func (o *CreateVolumeParams) SetProjectID(projectID string) {
