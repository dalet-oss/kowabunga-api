...
func (o *CreateTemplateParams) WithBody(body *models.Template) *CreateTemplateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create template params
func (o *CreateTemplateParams) SetBody(body *models.Template) {
	o.Body = body
}

// WithPoolID adds the poolID to the create template params
func (o *CreateTemplateParams) WithPoolID(poolID string) *CreateTemplateParams {
	o.SetPoolID(poolID)
	return o
}

// SetPoolID adds the poolId to the create template params
func (o *CreateTemplateParams) SetPoolID(poolID string) {
	o.PoolID = poolID
}
