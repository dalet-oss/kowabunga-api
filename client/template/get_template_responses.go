...
func (o *GetTemplateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /template/{templateId}] GetTemplate", response, response.Code())
	}
}
...
func (o *GetTemplateOK) Error() string {
	return fmt.Sprintf("[GET /template/{templateId}][%d] getTemplateOK  %+v", 200, o.Payload)
}
...
func (o *GetTemplateNotFound) Error() string {
	return fmt.Sprintf("[GET /template/{templateId}][%d] getTemplateNotFound ", 404)
}
