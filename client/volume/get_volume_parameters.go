...
type GetVolumeParams struct {
	...
	/* VolumeID.
	   ...
	   The ID of the storage volume to get.
	*/
	VolumeID string
...
// WithVolumeID adds the volumeID to the get volume params
func (o *GetVolumeParams) WithVolumeID(volumeID string) *GetVolumeParams {
	o.SetVolumeID(volumeID)
	return o
}

// SetVolumeID adds the volumeId to the get volume params
func (o *GetVolumeParams) SetVolumeID(volumeID string) {
	o.VolumeID = volumeID
}
