...
// WithRegionID adds the regionID to the get region params
func (o *GetRegionParams) WithRegionID(regionID string) *GetRegionParams {
	o.SetRegionID(regionID)
	return o
}

// SetRegionID adds the regionId to the get region params
func (o *GetRegionParams) SetRegionID(regionID string) {
	o.RegionID = regionID
}
