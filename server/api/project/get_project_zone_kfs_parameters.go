...
// GetProjectZoneKfsParams contains all the bound params for the get project zone kfs operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetProjectZoneKfs
...
//
// To ensure default values, the struct must have been initialized with NewGetProjectZoneKfsParams() beforehand.
func (o *GetProjectZoneKfsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetProjectZoneKfsParams) bindProjectID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetProjectZoneKfsParams) bindZoneID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
