...
func (o *DeleteTemplateURL) Build() (*url.URL, error) {
	...
	if templateID != "" {
		...
		return nil, errors.New("templateId is required on DeleteTemplateURL")
	}
...
func (o *DeleteTemplateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteTemplateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteTemplateURL")
	}
