...
func (o *GetHostURL) Build() (*url.URL, error) {
	...
	if hostID != "" {
		...
		return nil, errors.New("hostId is required on GetHostURL")
	}
...
func (o *GetHostURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetHostURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetHostURL")
	}
